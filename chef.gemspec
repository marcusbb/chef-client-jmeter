base_dir = "/home/marcus/ruby-workspace/chef"
...
Gem::Specification.new do |s|
  ...
  s.bindir       = "#{base_dir}/bin"
  s.executables  = %w( chef-client chef-solo knife chef-shell chef-apply )

  s.require_path = "#{base_dir}/lib"
  s.files = %w(Rakefile LICENSE README.md CONTRIBUTING.md) + Dir.glob("#{base_dir}/{distro,lib,tasks,spec}/**/*", File::FNM_DOTMATCH).reject {|f| File.directory?(f) }
end
